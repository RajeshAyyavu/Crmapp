...
<nav class="navbar  navbar-fixed-top navbar-expand-lg navbar-dark">
    <a class="navbar-brand" href="#">Leads<i class="fa-brands fa-squarespace fa-2xl" style="color: #f4f6fb;"></i>Connect</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="report"><i class="fa-solid fa-right-to-bracket fa-rotate-180 fa-lg"></i>Back</a>
        </li>
		...
		<table class="table-custom">
			...
			<c:forEach var="contacts" items="${contacts }">
				<tbody>
					...
					<td><a href="deletecontact?id=${contacts.id }"><i class="fa-solid fa-trash-can-arrow-up" style="color: #00040a;"></i></a></td>
					<td><a href="updatecontact?id=${contacts.id }"><i class="fa-solid fa-pen-to-square" style="color: #00040a;"></i></a></td>
					</tr>
