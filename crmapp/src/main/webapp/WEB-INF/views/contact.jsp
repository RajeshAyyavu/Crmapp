	...
	<nav class="navbar  navbar-fixed-top navbar-expand-lg navbar-dark">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="addcontact"><i
						class="fa-solid fa-user-plus" style="color: #000000;"></i>Add
						Contact</a></li>
				<li class="nav-item"><a class="nav-link" href="allcontacts"><i
						class="fa-solid fa-list-ul" style="color: #000205;"></i>All
						Contact</a></li>
