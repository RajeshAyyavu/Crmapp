		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link" href="home"><i
						class="fa-solid fa-house-chimney" style="color: #000205;"></i>Home</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="addlead"><i
						class="fa-solid fa-user-plus" style="color: #000000;"></i>Add Lead</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="listall"><i
						class="fa-solid fa-list-ul" style="color: #000205;"></i>All Leads</a>
				</li>
